...
public class LabelTranslatorSingleton {
    ...
    private void German() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Vertrauliche rmationen auf der Festplatte verschlüsseln");
        ...
        _addTranslation("Upload ", "rmationen hochladen");
        ...
        _addTranslation("Save debug  to file", "Save debug  to file");
    ...
    private void Hungarian() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Lemezen lévő érzékeny rmáció titkosítása");
        ...
        _addTranslation("Upload ", "Feltöltési infó");
        ...
        _addTranslation("Save debug  to file", "Debug  mentése fájlba");
    ...
    private void Vietnamese() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Mã hoá trên đĩa các thông tin nhạy cảm");
        ...
        _addTranslation("Upload ", "Thông tin tải lên");
    ...
    private void Italian() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Crittografa su disco le rmazioni sensibili");
        ...
        _addTranslation("About", " programma");
        ...
        _addTranslation("ALL YOUR SETTINGS, ACCOUNTS AND TRANSFERENCES WILL BE REMOVED. (THIS CAN'T BE UNDONE)\n\nDo you want to continue?", "Tutte e rmazioni, gli account e i trasferimenti verranno rimossi (l'operazione non può essere annullata).\n\nVuoi continuare?");
        ...
        _addTranslation("Save debug  to file", "Salva  debug nel file");
    ...
    private void Chinese() {
        ...
        _addTranslation("WARNING: USING MEGA API WITHOUT API KEY MAY VIOLATE ITS TERM OF USE.\n\nYOU SHOULD GET A KEY -> https://mega.nz/sdk (and set it in MegaBasterd ADVANCED SETTINGS).\n\nCREATE API KEY NOW?", "警告: 在沒有 API 密鑰的情況下使用 MEGA API 可能會違反其使用條款. API 密鑰獲取地址 -> https://mega.nz/sdk");
        _addTranslation("WARNING: Using proxies or VPN to bypass MEGA's daily download limitation may violate its Terms of Use. USE THIS OPTION AT YOUR OWN RISK.", "警告: 在沒有 API 密鑰的情況下使用 MEGA API 可能會違反其使用條款.\n\nAPI 密鑰獲取地址 -> https://mega.nz/sdk (並在 MegaBasterd 高級設置中進行設置).\n\n立即創建 API 密鑰?");
        _addTranslation("Using proxies or VPN to bypass MEGA's daily download limitation may violate its Terms of Use.\n\nUSE THIS OPTION AT YOUR OWN RISK.", "警告: 使用代理或 VPN 繞過 MEGA 的每日下載限制可能違反其使用條款. 使用此選項需您自擔風險.");
        _addTranslation("Execute this command when MEGA download limit is reached:", "達到 MEGA 下載限制時執行此命令:");
        _addTranslation("Use this proxy list (instead of the one included in MegaBasterd) Format is [*]IP:PORT[@user_b64:password_b64]", "使用此代理列表 (而不是 MegaBasterd 中包含的那個) 格式為 [*]IP:PORT[@user_b64:password_b64]");
        _addTranslation("Waiting for completion handler ... ***DO NOT EXIT MEGABASTERD NOW***", "等待完成處理程序 ... ***不要退出 MEGABASTERD***");
        _addTranslation("Finishing calculating CBC-MAC code (this could take a while) ... ***DO NOT EXIT MEGABASTERD NOW***", "完成計算CBC-MAC碼 (可能需要一段時間) ... ***不要退出 MEGABASTERD***");
        _addTranslation("Split content in different uploads", "拆分上傳內容");
        _addTranslation("Merge content in the same upload", "合併上傳內容");
        _addTranslation("How do you want to proceed?", "請選擇上傳方式?");
        _addTranslation("Put on TOP of waiting queue", "置頂等待隊列");
        _addTranslation("TOP", "置頂");
        _addTranslation("BOTTOM", "底部");
        _addTranslation("Freeze transferences before start", "開始前暫停傳輸");
        _addTranslation("UNFREEZE WAITING TRANSFERENCES", "取消暫停傳輸");
        _addTranslation("(FROZEN) Waiting to start...", "(暫停) 等待開始...");
        _addTranslation("(FROZEN) Waiting to start (", "(暫停) 等待開始)");
        _addTranslation("There are a lot of files in this folder.\nNot all links will be provisioned at once to avoid saturating MegaBasterd", "這個檔案夾里有很多檔案.\n並非所有連結都將立即提供以避免使 MegaBasterd 飽和");
        _addTranslation("You've tried to login too many times. Wait an hour.", "您嘗試登錄太多次. 等一個小時.");
        _addTranslation("MEGA LINK ERROR!", "MEGA 連結錯誤!");
        _addTranslation("Please enter 2FA PIN CODE", "請輸入 2FA PIN 碼");
        ...
        _addTranslation("Error registering download: file is already downloading.", "註冊下載時出錯: 檔案已在下載.");
        _addTranslation("FATAL ERROR! ", "致命錯誤! ");
        _addTranslation("ERROR: FILE NOT FOUND", "ERROR: 檔案未找到");
        _addTranslation("Mega link is not valid! ", "Mega 連結無效! ");
        _addTranslation("Checking your MEGA accounts, please wait...", "檢查您的 MEGA 帳號, 請稍等...");
        _addTranslation("Check for updates", "檢查更新");
        _addTranslation("Checking, please wait...", "檢查中, 請稍等...");
        _addTranslation("You have the latest version ;)", "有最新版本 ");
        _addTranslation("Copy MegaBasterd download URL", "複製 MegaBasterd 下載 URL");
        _addTranslation("Made with love (and with no warranty) by tonikelope.", "Tonikelope 編譯構建（沒有保證）.");
        _addTranslation("Yet another unofficial (and ugly) cross-platform MEGA downloader/uploader/streaming suite.", "官方 (and ugly) 跨平台的 MEGA 下載器/上傳者/流媒體套件.");
        _addTranslation("MEGA URL was copied to clipboard!", "MEGA URL 已複製到剪貼簿!");
        _addTranslation("MegaBasterd NEW VERSION is available! -> ", "MegaBasterd 新版本可用! -> ");
        _addTranslation("Selecting folder...", "選擇檔案夾...");
        _addTranslation("MERGE FILE", "合併 檔案");
        _addTranslation("Delete parts after merge", "合併後刪除部分");
        _addTranslation("Remove selected", "刪除選中");
        _addTranslation("SPLIT FILE/s", "分割檔案");
        _addTranslation("Encrypt on disk sensitive rmation", "加密硬碟敏感帳號");
        _addTranslation("Allow using MEGA accounts for download/streaming", "允許使用 MEGA 帳號進行下載/流媒體");
        _addTranslation("Please wait...", "請稍等...");
        _addTranslation("CANCEL RETRY", "取消重試");
        _addTranslation("SPLITTING FILE...", "分割檔案...");
        _addTranslation("Open folder", "打開檔案夾");
        _addTranslation("RESUME DOWNLOAD", "繼續下載");
        _addTranslation("Close", "關閉");
        _addTranslation("Add files", "新增檔案");
        _addTranslation("IMPORT SETTINGS", "導入設置");
        _addTranslation("RESET MEGABASTERD", "重置 MEGABASTERD");
        _addTranslation("RESET ACCOUNTS", "重置 帳號");
        _addTranslation("Verify file integrity (when download is finished)", "驗證檔案完整性 (下載完成時)");
        _addTranslation("Let's dance, baby", "開始下載");
        _addTranslation("Unlock accounts", "解鎖帳號");
        _addTranslation("Use MegaCrypter reverse mode", "使用 MegaCrypter 反向模式");
        _addTranslation("Select (any) file part", "選擇 (任何) 檔案部分");
        _addTranslation("Add folder", "新增檔案夾");
        _addTranslation("Adding files, please wait...", "正在新增檔案, 請稍候...");
        _addTranslation("Restart", "重新開始");
        _addTranslation("Use SmartProxy", "使用智能代理");
        _addTranslation("PAUSE DOWNLOAD", "暫停下載");
        _addTranslation("Change it", "更改");
        _addTranslation("EXPORT SETTINGS", "導出設置");
        _addTranslation("Change output folder", "更改輸出檔案夾");
        _addTranslation("Add account", "新增帳號");
        _addTranslation("Select file/s", "選擇檔案");
        _addTranslation("Opening file...", "打開檔案...");
        _addTranslation("CANCEL DOWNLOAD", "取消下載");
        _addTranslation("REMOVE ALL EXCEPT THIS", "刪除除此之外的所有內容");
        _addTranslation("Loading DLC, please wait...", "加載DLC, 請稍候...");
        _addTranslation("Changing output folder...", "更改輸出檔案夾...");
        _addTranslation("RESUME UPLOAD", "繼續上傳");
        _addTranslation("Limit upload speed", "上傳速度限制");
        _addTranslation("CANCEL", "取消");
        _addTranslation("Use multi slot download mode", "使用多線程下載模式");
        _addTranslation("Selecting file...", "選擇檔案...");
        _addTranslation("Copy folder link", "複製檔案夾連結");
        _addTranslation("Limit download speed", "下載速度限制");
        _addTranslation("REMOVE THIS", "刪除這個");
        _addTranslation("Copy file link", "複製檔案連結");
        _addTranslation("Load DLC container", "加載 DLC 容器");
        _addTranslation("Adding folder, please wait...", "正在新增檔案夾, 請稍候...");
        ...
        _addTranslation("Checking MEGA account...", "檢查 MEGA 帳號...");
        _addTranslation("SAVE", "保存");
        _addTranslation("New download", "新建下載");
        _addTranslation("New upload", "新建上傳");
        _addTranslation("New streaming", "新增流媒體");
        _addTranslation("Split file", "拆分檔案");
        _addTranslation("Merge file", "合併檔案");
        _addTranslation("Remove all no running downloads", "刪除所有未運行的下載");
        _addTranslation("Remove all no running uploads", "刪除所有未運行的上傳");
        _addTranslation("Edit", "編輯");
        _addTranslation("Settings", "設置");
        ...
        _addTranslation("Max parallel downloads:", "最大下載並行:");
        _addTranslation("Max parallel uploads:", "最大上傳並行:");
        _addTranslation("Note: slots consume RAM, so use them moderately.", "注意: 線程會消耗 RAM, 因此請適度使用它們.");
        _addTranslation("Note: you can use a (optional) alias for your email addresses -> bob@supermail.com#bob_mail (don't forget to save after entering your accounts).", "注意: 可以使用一個 (選擇) 您的電子郵件地址的別名 -> bob@supermail.com#bob_mail (輸入您的帳號後不要忘記保存).");
        _addTranslation("Your MEGA accounts:", "您的 MEGA 帳號:");
        _addTranslation("Your ELC accounts:", "您的 ELC 帳號:");
        _addTranslation("Note: restart required.", "注意: 需要重啓.");
        _addTranslation("Note: restart might be required.", "注意: 可能需要重新啓動.");
        _addTranslation("Font ZOOM (%):", "字體 縮放 (%):");
        _addTranslation("Note: MegaBasterd will use this proxy for ALL connections.", "注意: MegaBasterd 將使用此代理進行所有連接.");
        _addTranslation("Port:", "端口:");
        _addTranslation("Settings successfully saved!", "設置保存成功!");
        _addTranslation("Settings successfully imported!", "導入設置成功!");
        _addTranslation("Settings successfully exported!", "導出設置成功!");
        _addTranslation("Settings successfully reset!", "重置設置成功!");
        _addTranslation("There were errors with some accounts (email and/or password are/is wrong). Please, check them:\n\n", "部分帳號存在錯誤 (email 和/或密碼是/錯誤). 請檢查:\n\n");
        _addTranslation("Settings saved", "設置已保存");
        _addTranslation("Settings imported", "導入設置");
        _addTranslation("Settings exported", "導出設置");
        _addTranslation("Settings reset", "重置設置");
        _addTranslation("MegaBasterd will restart", "MegaBasterd 將重新啓動");
        _addTranslation("Restart required", "需要重啓");
        _addTranslation("File is not readable!", "檔案不可讀");
        _addTranslation("Folder is not readable!", "檔案夾不可讀");
        _addTranslation("BAD PASSWORD!", "密碼錯誤!");
        _addTranslation("Passwords does not match!", "密碼不匹配!");
        _addTranslation("Please, paste a Mega/MegaCrypter/ELC link!", "請粘貼或輸入 Mega/MegaCrypter/ELC 連結!");
        ...
        _addTranslation("Only SAVED settings and accounts will be exported. (If you are unsure, it is better to save your current settings and then export them).\n\nDo you want to continue?", "只會導出保存的設置和帳號. (如果您不確定, 最好保存當前設置 然後導出).\n\n你確定繼續嗎?");
        _addTranslation("Master password will be reset and all your accounts will be removed. (THIS CAN'T BE UNDONE)\n\nDo you want to continue?", "主密碼將被重置, 您的所有帳號都將被刪除. (將無法撤消)\n\n你確定繼續嗎?");
        _addTranslation("ALL YOUR SETTINGS, ACCOUNTS AND TRANSFERENCES WILL BE REMOVED. (THIS CAN'T BE UNDONE)\n\nDo you want to continue?", "您的所有設置, 帳號和轉賬都將被刪除. (將無法撤消)\n\n你確定繼續嗎?");
        _addTranslation("Remove all no running downloads?", "刪除所有未運行的下載?");
        _addTranslation("Warning!", "警告!");
        _addTranslation("Remove all no running uploads?", "刪除所有未運行的上傳?");
        _addTranslation("Please, enter your master password", "請輸入您的主密碼");
        _addTranslation("WARNING: if you forget this password, you will have to insert all your accounts again.", "警告: 如果您忘記了此密碼, 您需要重新插入所有帳號.");
        _addTranslation("New pass:", "新增通行證:");
        _addTranslation("Confirm new:", "確認新增:");
        _addTranslation("Verifying your password, please wait...", "正在驗證密碼, 請稍候...");
        _addTranslation("Processing your password, please wait...", "正在處理密碼, 請稍候...");
        _addTranslation("Downloads", "下載");
        _addTranslation("Uploads", "上傳");
        _addTranslation("Accounts", "帳號");
        _addTranslation("Advanced", "高級");
        _addTranslation("Language:", "語言:");
        _addTranslation("English", "English");
        _addTranslation("Spanish", "Spanish");
        _addTranslation("Loading files, please wait...", "正在加載檔案, 請稍候...");
        _addTranslation("Checking account quota, please wait...", "正在查看帳號配額, 請稍候...");
        ...
        _addTranslation("Download folder:", "下載目錄:");
        _addTranslation("Split size (MBs):", "分割尺寸 (MBs):");
        _addTranslation("File successfully splitted!", "檔案拆分成功!");
        _addTranslation("File successfully merged!", "檔案合併成功!");
        _addTranslation("File successfuly downloaded!", "檔案下載成功!");
        _addTranslation("Download paused!", "暫停下載!");
        _addTranslation("Downloading file from mega ...", "從 MEGA 下載檔案 ...");
        _addTranslation("Copy link", "複製連結");
        _addTranslation("Downloading file from mega ", "從 MEGA 下載檔案 ");
        _addTranslation("EXIT NOW", "立即退出");
        _addTranslation("Download CANCELED!", "下載已取消!");
        _addTranslation("Upload CANCELED!", "上傳已取消!");
        _addTranslation("Uploading file to mega (", "上傳檔案到 MEGA");
        _addTranslation("Put your MEGA/MegaCrypter/ELC link here in order to get a streaming link:", "請輸入 MEGA/MegaCrypter/ELC 連結以獲得流媒體連結:");
        _addTranslation("Use this account for streaming:", "使用此帳號進行流式傳輸:");
        _addTranslation("Use this account for download:", "使用此帳號下載:");
        _addTranslation("Streaming link was copied to clipboard!\nRemember to keep MegaBasterd running in background while playing content.", "流媒體連結已複製到剪貼簿!\n記得在播放內容時讓 MegaBasterd 在後台運行.");
        _addTranslation("CANCEL UPLOAD", "取消上傳");
        _addTranslation("Upload paused!", "上傳已暫停!");
        _addTranslation("Stopping download safely before exit MegaBasterd, please wait...", "退出 MegaBasterd 前安全停止下載, 請稍候...");
        _addTranslation("Stopping upload safely before exit MegaBasterd, please wait...", "退出 MegaBasterd 前安全停止上傳, 請稍候...");
        _addTranslation("Starting download, please wait...", "開始下載, 請稍候...");
        _addTranslation("Starting upload, please wait...", "開始上傳, 請稍候...");
        _addTranslation("Starting download (retrieving MEGA temp link), please wait...", "開始下載 (檢索 MEGA 臨時連結), 請稍等...");
        _addTranslation("File exists, resuming download...", "檔案存在, 正在恢復下載...");
        _addTranslation("Truncating temp file...", "截斷臨時檔案...");
        _addTranslation("Waiting to check file integrity...", "等待檢查檔案完整性...");
        _addTranslation("Checking file integrity, please wait...", "正在檢查檔案完整性, 請稍候...");
        _addTranslation("Provisioning download, please wait...", "下載配置, 請稍候...");
        _addTranslation("Waiting to start...", "等待開始...");
        _addTranslation("Provisioning upload, please wait...", "配置上傳, 請稍候...");
        _addTranslation("Waiting to start (", "等待開始");
        _addTranslation("Creating new MEGA node ... ***DO NOT EXIT MEGABASTERD NOW***", "創建新的 MEGA 節點 ... ***不要退出 MEGABASTERD***");
        _addTranslation("File successfully uploaded! (", "檔案上傳成功!");
        _addTranslation("PAUSE ALL", "暫停所有");
        _addTranslation("RESUME ALL", "恢復所有");
        _addTranslation("MEGA folder link was copied to clipboard!", "MEGA 檔案夾連結已複製到剪貼簿!");
        _addTranslation("MEGA file link was copied to clipboard!", "MEGA 檔案連結已複製到剪貼簿!");
        _addTranslation("Pausing download ...", "暫停下載 ...");
        _addTranslation("Pausing upload ...", "暫停上傳 ...");
        ...
        _addTranslation("UPLOAD FAILED! (Empty completion handler!)", "上傳失敗! (空完成處理程序!)");
        _addTranslation("UPLOAD FAILED: too many errors", "上傳失敗: 錯誤過多 請重試");
        _addTranslation("UPLOAD FAILED: FATAL ERROR", "上傳失敗: 致命錯誤 請重試");
        _addTranslation("BAD NEWS :( File is DAMAGED!", "壞消息 :( 檔案已損壞!");
        _addTranslation("MEGA LINK TEMPORARILY UNAVAILABLE!", "MEGA 連結暫時不可用!");
        _addTranslation("File temporarily unavailable! (Retrying in ", "檔案暫時不可用! (請重試 ");
        _addTranslation(" secs...)", " 秒...");
        _addTranslation(" (Retrying in ", " (重試 ");
        _addTranslation("Proxy settings", "代理設置");
        _addTranslation("Authentication", "驗證");
        _addTranslation("Upload ", "上傳帳號");
        _addTranslation("Files", "檔案");
        _addTranslation("Username:", "帳號:");
        _addTranslation("Password:", "密碼:");
        _addTranslation("Link was copied to clipboard!", "連結已複製到剪貼簿!");
        _addTranslation("Checking if there are previous downloads, please wait...", "檢查是否有以前的下載, 請稍等...");
        _addTranslation("Checking if there are previous uploads, please wait...", "檢查是否有以前的上傳, 請稍等...");
        _addTranslation("Restore window", "恢復窗口");
        _addTranslation("EXIT", "退出");
        _addTranslation("File successfully downloaded!", "檔案下載成功!");
        _addTranslation("Quota used: ", "配額使用: ");
        _addTranslation("Streaming server: ON (port ", "流媒體服務器: ON (端口 ");
        _addTranslation("MC reverse mode: ON (port ", "MC 反向模式: ON (端口 ");
        _addTranslation("Joining file chunks, please wait...", "加入檔案塊, 請稍等...");
        _addTranslation("Close MegaBasterd when all transfers finish", "所有傳輸完成後關閉 MegaBasterd");
        _addTranslation("Use custom temporary directory for chunks storage", "使用自定義臨時目錄進行存儲");
        _addTranslation("CANCEL ALL DOWNLOADS", "取消所有下載");
        _addTranslation("Save debug  to file", "將調試帳號保存為");
        _addTranslation("Use this proxy list Format is [*]IP:PORT[@user_b64:password_b64]", "使用此代理列表格式為 [*]IP:PORT[@user_b64:password_b64]");
        _addTranslation("Slots", "線程");
        _addTranslation("MC reverse mode: OFF", "MC反向模式：OFF");
        _addTranslation("Pre:", "預:");
        _addTranslation("Pro:", "Pro:");
        _addTranslation("Wait:", "等待:");
        _addTranslation("Run:", "下載中:");
        ...
        _addTranslation("Hungarian", "Hungarian");
        _addTranslation("Turkish", "Turkish");
        _addTranslation("Streaming server: OFF (port ", "流媒體服務器: OFF (端口");
        ...
        _addTranslation("Link Grabber", "請輸入下載連結");
        _addTranslation("Select DLC container", "選擇 DLC 容器");
        ...
        _addTranslation("User", "帳號");
        _addTranslation("Password", "密碼");
        _addTranslation("API-KEY", "API-KEY");
        _addTranslation("Test", "測試");
        _addTranslation("OK", "確定");
        _addTranslation("No", "否");
        _addTranslation("MC reverse mode: OFF", "MC反向模式：OFF");
        _addTranslation("Restore MegaBasterd window", "恢復 MegaBasterd 窗口");
    ...
    private void Turkish() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Disk üzerindeki hassas bilgileri şifreleyin");
        ...
        _addTranslation("Upload ", "Yükleme bilgisi");
        ...
        _addTranslation("Save debug  to file", "Hata ayıklama bilgilerini dosyaya kaydet");
    ...
    private void Spanish() {
        ...
        _addTranslation("Encrypt on disk sensitive rmation", "Cifrar en disco datos sensibles");
        ...
        _addTranslation("Upload ", "rmación de la subida");
        ...
        _addTranslation("Save debug  to file", "Generar fichero de depuración");
        _addTranslation("Use this proxy list Format is [*]IP:PORT[@user_b64:password_b64]", "Use this proxy list Format is [*]IP:PORT[@user_b64:password_b64]");
        _addTranslation("Slots", "Slots");
        _addTranslation("MC reverse mode: OFF", "MC reverse mode: OFF");
        _addTranslation("Pre:", "Pre:");
